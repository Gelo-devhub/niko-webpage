...
export default function Footer() {
  ...
  return (
    <footer>
      <a href="#top" className={`logo ${roboto.className}`}>
      ...
      <span>
        ...
        <Link className={`contact ${poppins.className}`} href="/Contact">
          Contact
        </Link>
      </span>
      <a href="https://portfolio-8ffa3.web.app/">
        ©Ui design / programed by Geldev
      </a>
    </footer>
  );
}
